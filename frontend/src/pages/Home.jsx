...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 overflow-hidden">
      ...
      {/* Final CTA */}
      <section className="relative px-6 md:px-12 py-24 text-center bg-white dark:bg-gray-900 overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            >
              <span className="relative z-10 flex items-center">
                {isAuthenticated ? "Continue Learning" : "Start"}
                <FiArrowRight className="ml-2 transition-transform group-hover:translate-x-1" />
              </span>
              <motion.span
                className="absolute inset-0 bg-gradient-to-r from-sky-600 to-indigo-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          ...
          <div className="mt-8 text-sm text-gray-500 dark:text-gray-400">
            No credit card required • Version 1.0 free • Cancel anytime
          </div>
        </motion.div>
      </section>
    </div>
